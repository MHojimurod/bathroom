...
const AboutUsPage: React.FC = () => {
  ...
  const quote = t.aboutUs.quote
    ...
    .replace(/<b>(.*?)<\/b>/g, '<span class="font-semibold text-gray-900">$1</span>');
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img src="/images/about-us-1.jpg" alt="Our design process" className="rounded-lg shadow-xl" />
            </div>
          </div>
        </section>
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="md:order-1">
              <img src="/images/about-us-2.jpg" alt="Sustainable materials" className="rounded-lg shadow-xl" />
            </div>
          </div>
        </section>
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img src="/images/about-us-3.jpg" alt="Our design process" className="rounded-lg shadow-xl" />
            </div>
          </div>
        </section>
      </div>
